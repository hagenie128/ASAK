...
> 정본 맵: [CURRENT_IMPLEMENTATION_MAP.md](../planning/CURRENT_IMPLEMENTATION_MAP.md)
...
상세: [CANONICAL_CONTRACT_DECISIONS.md](../governance/CANONICAL_CONTRACT_DECISIONS.md)
