...
| `docs/planning/current-implementation-map-2026-07-16.md` | 화면 상태표 |
...
| `docs/planning/implementation-priority-2026-07-16.md` | 목표 순서 — 현실은 MAP/baseline |
| `docs/governance/product-bible-index-2026-07-16.md` | 세부는 Pack README · 입구는 product_bible/README |
| `docs/governance/repository-cleanup-inventory-2026-07-16.md` | 정리 이력 |
...
| `docs/governance/repository-cleanup-inventory-2026-07-16.md` | 정리 스냅샷 |
