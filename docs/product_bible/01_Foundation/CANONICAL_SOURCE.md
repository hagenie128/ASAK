...
|---|---|
| Product policy | `ASAK/docs/product_bible/01_Foundation` |
| Design token | `ASAK/docs/design` |
| Screen ID | `ASAK/docs/product_bible/07_Screen_Bible/SCREEN_REGISTRY.md` |
| Figma latest screen | 05-B, 06-B 또는 승인된 05-C, 06-C |
| Prototype flow | PrototypeMap v2 `107:7720` |
| React component | 각 앱 저장소 실제 source |
| API contract | `ASAK/docs/product_bible/06_Engineering_Bible/05-api` |
| DB schema | `ASAK/docs/product_bible/06_Engineering_Bible/04-database` + migration/seed |
| Feature policy | `ASAK/docs/product_bible/02_Order_Cart_Payment` ~ `05_Accessibility_Timeout_Error` |
| QA | `ASAK/docs/product_bible/09_QA_Bible` |
| AI instruction | `ASAK/docs/product_bible/10_AI_Master_Bible` |
