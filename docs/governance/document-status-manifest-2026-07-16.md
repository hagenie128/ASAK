...
|---|---|---|
| `docs/START_HERE.md`, `docs/wiki/wbs.md` | `CURRENT` | 실행 진입·작업 목록 |
| `docs/product_bible/**` | `CANONICAL` | 정책·화면·계약 |
| `docs/governance/**` | `CANONICAL` | 계약·상태 정책 |
| `docs/design/**` | `REFERENCE` | 0718 Figma와 실행 플러그인 |
| `docs/wiki/*-definition.md` | `HISTORY` | 과거 Hub/Notion export |
| 날짜 고정 baseline·구현 맵 | `HISTORY` | 당시 코드 실측 |
