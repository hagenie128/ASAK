...
| Figma 가이드 | `docs/design/figma-guide.md` + 현재 Product Bible | 날짜별 Figma 감사/프롬프트 및 회의 기록 | 운영 지침 vs 이력 인수 프롬프트 | 디자인 플러그인 및 팀 문서 | Figma 담당자 확인 후 종료된 날짜별 감사/프롬프트만 아카이브. |
