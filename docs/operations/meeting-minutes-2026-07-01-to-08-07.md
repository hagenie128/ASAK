...
`worklog/weekly/*`를 비롯해 이 경로를 가리키는 링크가 여러 곳에 있어, 파일을 지우면 링크가 깨집니다.
`wbs-v2` / `wbs-schedule`와 같은 **리다이렉트 스텁** 처리 방식을 따릅니다.

## 이력

| 일자 | 내용 |
|---|---|
| 2026-08-07 | 초안. 2조 채널·팀 협의·로컬 워크로그 통합. |
| 2026-08-07 | 참고 문서를 현재 정본으로 갱신. |
| 2026-08-07 | **리다이렉트 스텁으로 전환.** 본문은 주차별 정본(`meeting-minutes/`)으로 이관 완료 — 대조 결과 이 문서 고유 내용 없음. |
