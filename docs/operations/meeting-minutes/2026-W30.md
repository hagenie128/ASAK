...
| 일자 | 내용 |
|---|---|
| 7/21 | Vercel 미리보기 공개 — [asak-admin.vercel.app](https://asak-admin.vercel.app/) · [asak-kiosk.vercel.app](https://asak-kiosk.vercel.app/) |
| 7/21 | `ASAK_FRONT_S9_ULTRA_SCALE_APPLY_GUIDE.md` 공유 (선생님) |
| 7/22 | 프론트 발표 PPT 제출 (`frontend_2조_아삭.pptx`) · 백엔드 clone `github.com/nayeon0828/ASAK-backend` |
| 7/23 | 미사용 스캐폴딩 클래스 도입 시점 정리 (김나연 — Swagger·JWT·BaseEntity 등 **필요 시점에만**) |
