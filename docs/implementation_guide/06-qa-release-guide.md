...
`Build → Smoke → Feature → Integration → Data Integrity → 회귀 점검 → Accessibility → Demo → Release`
...
- [회귀 점검 Suite](../product_bible/09_QA_Bible/docs/10-qa/06-regression/REGRESSION_SUITE.md)
