...
> → 현실: [**START_HERE**](../START_HERE.md) · [baseline](../wiki/current-status-baseline.md) · [CURRENT_IMPLEMENTATION_MAP](impl-map-2026-07-16.md) · [wbs.md](../wiki/wbs.md)
> 갱신 **2026-07-20:** Slice 1~3은 UI·mock 일부 있음. Slice 4(결제)·5(Admin)는 UI shell / 정적 UI.

> `DECIDED_PENDING_CODE_CHANGE`: canonical은 [Canonical Contract Decisions](../governance/contract-decisions-2026-07-16.md). 코드 path는 아직 legacy/kebab.
