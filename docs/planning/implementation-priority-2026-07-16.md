...
> → 현실: [**START_HERE**](../START_HERE.md) · [baseline](../wiki/current-status-baseline.md) · [CURRENT_IMPLEMENTATION_MAP](current-implementation-map-2026-07-16.md) · [wbs.md](../wiki/wbs.md)
