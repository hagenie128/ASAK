...
> Notion·팀 문서 기준 요약 (2026-07-06). 상세는 Notion 프로젝트 허브 참고.
...
**고객 키오스크 (6 UI 단계, SCR-001~008 ID)**: 홈·매장/포장(SCR-001) → 메뉴선택(SCR-003) → 메뉴상세/옵션(SCR-004) → 장바구니·주문확인·컨펌 팝업(SCR-005) → 결제·로딩(SCR-007) → 주문완료(SCR-008) — SCR-002·006은 병합됨(참조용 ID 유지)
