...
> **2026-07-14 정본:** SCR-001은 키오스크 홈(매장·포장)이고, 관리자 로그인은 SCR-015다. SCR-012는 결제 화면의 오버레이다. 전체 매핑과 DevCopilot 보정 절차는 [피드백 반영 기준](../_archive/team-audits-2026-07/2026-07-14-feedback-resolution.md)을 따른다.
