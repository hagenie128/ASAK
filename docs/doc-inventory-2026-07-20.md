...
> 진입: [START_HERE](START_HERE.md) · 태그: [doc-tag-index-2026-07-20.md](doc-tag-index-2026-07-20.md)
...
| `docs/planning/impl-map-2026-07-16.md` | `HISTORY` 2026-07-23 SCR별 상태표 |
| `docs/planning/impl-hub.md` | Bible / guide / PLAN 역할 표 |
...
| `docs/governance/contract-decisions-2026-07-16.md` | 계약 |
| `docs/governance/doc-manifest-2026-07-16.md` | 상태 매니페스트 |
...
| `docs/implementation-guide/00-start-here.md` | 구현 작업대 |
...
| `docs/planning/impl-priority-2026-07-16.md` | 구현 맵 · impl-hub |
