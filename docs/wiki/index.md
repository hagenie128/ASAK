...
- [추적성 매트릭스](traceability-matrix.md)
- [향후 범위](future-scope.md)
- [레거시 WBS2 매핑 감사](legacy-wbs2-mapping-audit-2026-07-16.md) (역사)
- [WBS 일정(레거시)](wbs-schedule.md) — 실행에 쓰지 말 것

## DB·API·QA (명세)

- [DB 약어](db-abbreviation-glossary.md)
- [DB 감사 계획](db-audit-plan.md)
- [REST API 명세](rest-api-spec.md)
- [요구사항](requirements-definition.md)
- [시나리오](user-scenarios.md)
- [QA 케이스](qa-test-cases.md)
- [화면·Figma](screen-design-figma.md)

## 스냅샷

- [DevCopilot baseline 2026-07-16](snapshots/devcopilot-baseline-2026-07-16.md) (역사)
