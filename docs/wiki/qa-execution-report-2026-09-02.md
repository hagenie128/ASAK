...
**주의:** 결제수단 Admin→Kiosk 반영 **미동작**, 품절 `affectedMenuCount` 전부 0, READY 취소 **500**.
...
| **TC-013** 매출 | **PASS** | today/week/month KPI, monthly 2026-08, **8/28 순매출 890,300** 일치 |
...
| READY 주문 취소 | **FAIL** | orderId 51984 → HTTP **500** (서버 오류) |
