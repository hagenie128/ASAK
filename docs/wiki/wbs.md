...
| WBS-084 | 배포 전 빌드·환경·체크리스트 점검하기 | 하진, 나연 | DELAYED | 상 | 2026-08-14~2026-08-28 | 전체 저장소 | 모든 저장소 점검 통과; 배포 환경·담당 확인; 배포 후보 확인 | 완료 기준: 체크리스트 승인 및 배포 후보 근거 첨부. [배포 체크리스트](../product_bible/09_QA_Bible/RELEASE_AND_DEMO_OPERATIONS.md); 환경·배포 후보 근거 아직 없음. |
| WBS-085 | 발표 슬라이드·데모 대본·비상 계획 끝내기 | 하진, 나연 | TODO | 중 | 2026-08-14~2026-08-28 | 전체 저장소 | 슬라이드·대본·시연 1~5 순서·비상 대응·최종 리허설 기록을 팀이 검토 | 완료 기준: 팀 검토 및 리허설 기록 완료. 2026-07-03 회의에서 발표·시연을 하진·나연 공동 담당; [시연 시나리오](../product_bible/09_QA_Bible/RELEASE_AND_DEMO_OPERATIONS.md). |
