...
| 순서 | 초점 | 관련 ID |
|---|---|---|
| 1 | 장치 이벤트/RTOS — `device_event`, 콘솔 출력, Spring↔React | RTOS-DEVICE-001~003 · API-019 |
| 2 | 키오스크 장바구니 → 주문 → 결제 실연동 잔여 | WBS-031~034, 060~061, 069 |
| 3 | 관리자 주문 검증 · 메뉴 CRUD 잔여 (기능 마감 전 유지) | WBS-041~045, 063, 070 |
