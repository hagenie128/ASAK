...
|-----|--------|------|-----|-----------|------|------|
| SCR-001 | 홈 화면 | Kiosk Screens | FWD-UI-002 | https://www.figma.com/design/iqaoVwFjFE6Zq1WpOVgjeG/kiosk_design?node-id=61-273 | WIREFRAME | |
| SCR-002 | 먹고가기 / 포장 선택 | Kiosk Screens | FWD-ORDER-001 | https://www.figma.com/design/iqaoVwFjFE6Zq1WpOVgjeG/kiosk_design?node-id=75-2 | WIREFRAME | |
...
| SCR-005 | 장바구니 | Kiosk Screens | FWD-CART-001, FWD-CART-002 | https://www.figma.com/design/iqaoVwFjFE6Zq1WpOVgjeG/kiosk_design?node-id=75-6 | WIREFRAME | |
| SCR-006 | 주문 확인 | Kiosk Screens | FWD-CART-001, FWD-CART-002, FWD-ORDER-001, DEV-ORDER-001 | https://www.figma.com/design/iqaoVwFjFE6Zq1WpOVgjeG/kiosk_design?node-id=75-7 | WIREFRAME | |
...
| Page | SCR | 내용 |
|------|-----|------|
| **02. User Flow** | — | 표지·팀 정보, DS 토큰 요약, 고객·관리자 흐름, 프로토타입 링크, Archive 참고 |
...
Frame 이름: `SCR-001 홈` · wireframe: [Notion SCR 화면별 가이드](https://app.notion.com/p/39451ef04f0b81109d07c01293d73c6d)
