...
2. `ASAK/docs/design/ASAK_FIGMA_PRECISE_FIX_CHECKLIST_2026-07-18.md` — 실제로 Figma에서 뭘 고쳤고 뭘 안 고쳤는지 최종 상태. 특히 맨 아래 "D. 나(Claude)에게 남긴 것" 섹션에 뭐가 완료됐고 뭐가 보류됐는지 정확히 적혀 있음.
