...
- `figma-apply-ds02-theme-plugin/`
- `figma-create-ds02-components-plugin/`
- `kiosk-tokens.css`, `color-swatches.html`

날짜가 붙은 QA·교정 계획·토큰 보고서는 Git 이력으로 이동했습니다. 신규 구현 판단은 Pack 07 Screen Bible, 실행 코드, [`ui-index.md`](../../../ui-index.md)를 우선합니다.
