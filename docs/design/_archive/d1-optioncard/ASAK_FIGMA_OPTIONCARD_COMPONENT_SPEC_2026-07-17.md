...
> 실행: 이 명세를 실제로 만드는 절차는 [ASAK_FIGMA_D1B_OPTION_CARD_COMPONENT_WORK_ORDER_2026-07-17.md](ASAK_FIGMA_D1B_OPTION_CARD_COMPONENT_WORK_ORDER_2026-07-17.md) 참고 — 그 문서도 아직 실행 전 단계.
...
실제 생성 절차, Sandbox 원칙, 바인딩 검증 절차, 마이그레이션 절차는 [ASAK_FIGMA_D1B_OPTION_CARD_COMPONENT_WORK_ORDER_2026-07-17.md](ASAK_FIGMA_D1B_OPTION_CARD_COMPONENT_WORK_ORDER_2026-07-17.md)에 정리했다. 이 명세 문서는 "무엇을 만들지"만 정의하며, "어떻게 안전하게 만들지"는 Work Order 문서의 소관이다.
