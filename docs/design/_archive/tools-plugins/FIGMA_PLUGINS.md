...
디자인 정본은 [kiosk-design-system.md](../legacy-ds02-scr/kiosk-design-system.md)입니다. Candidate B 선택 기록은 [Archive](../legacy-ds02-scr/kiosk-design-system-candidate-B.md)에 보존합니다. 후보 프레임 생성 플러그인은 DS-02 컴포넌트 플러그인으로 통합해 제거했습니다.
