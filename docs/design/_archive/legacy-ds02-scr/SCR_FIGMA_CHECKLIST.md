...
| Figma 수동 | [figma-merge-scr-guide.md](./figma-merge-scr-guide.md) |
...
플러그인: `docs/design/figma-create-ds02-components-plugin/` · 상세: [figma-merge-scr-guide.md](./figma-merge-scr-guide.md)
