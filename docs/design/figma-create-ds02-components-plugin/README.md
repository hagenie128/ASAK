...
| 매핑 문서 | [y2k-to-ds02-migration.md](../y2k-to-ds02-migration.md) |
...
1. 새 4×4 아이콘 시트 PNG를 `assets/asak-kiosk-icons-4x4.png`에 덮어쓰기 (행·열 순서는 [kiosk-icon-pack-prompt.md](../prompts/kiosk-icon-pack-prompt.md) 및 위 `IconSheet` 표와 동일해야 함)
2. base64 주입:
...
정본: [kiosk-design-system-candidate-B.md](../kiosk-design-system-candidate-B.md)
