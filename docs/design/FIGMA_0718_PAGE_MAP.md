...
| 페이지 | node / page | 용도 |
|--------|-------------|------|
| 🏁 00. START HERE | `0:1` | **ASAK 0718 Master Index** — 보는 순서, 코드↔Figma 현실, DoD |
| 🎨 01-C Foundations | `148:12745` | Variable 토큰 |
| 🧩~🛠️ 02~04-C Components | Shared / Kiosk / Admin | Variant·상태 |
| 🛒 05-C Kiosk Screens | `134:7720` | 키오스크 화면 (~89 SCR 프레임) |
| 📊 06-C Admin Screens | `134:10606` | 관리자 화면 (~83 SCR 프레임) |
| 🔍 07-C QA | `190:2` | **ASAK 0718 Project Gap Matrix** (COMPLETE/PARTIAL/MISSING) |
| 🔀 09. User Flows | `3183:13` | **코드 라우트 기준** 흐름 |
| 📐 10. Handoff / Specs | `3184:2` | 가져올 것/말 것 · Variant 체크 |

구 0715 시대 보드는 `ARCHIVED_*`로 보관 (삭제하지 않음).
