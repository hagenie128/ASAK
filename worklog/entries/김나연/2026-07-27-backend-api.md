# 2026-07-27 update : getMenuList 추가 백업 외 2건

> **템플릿:** [03-work-log-template.md](../../../docs/guides/03-work-log-template.md) · **일일:** [2026-07-27.md](../../daily/김나연/2026-07-27.md)
...
- 기대 결과: 팀 캘린더·포트폴리오에서 2026-07-27 작업 흔적을 추적 가능하게 한다.

## 3. 직접 구현 영역

커밋 메시지 기준 변경 요약:

- `ASAK-back` `aa7c303` — update : getMenuList 추가 백업
- `ASAK-back` `07f6605` — fix: userMenuCotnroller 반환 삽입 부분 코드 수정
- `ASAK-back` `c2179ae` — update : feature/user/API-003  백업
...
- 확인 결과: 2026-07-27 작성자 커밋 3건 확인. **기능·API·UI 재검증 미실행.**

## 11. 포트폴리오용 요약

- 2026-07-27 김나연: ASAK-back: 커밋 3건 (update : getMenuList 추가 백업 등)

## 12. 첨부하면 좋은 자료

- Git: 위 커밋 해시
- 일일: `worklog/daily/김나연/2026-07-27.md`
