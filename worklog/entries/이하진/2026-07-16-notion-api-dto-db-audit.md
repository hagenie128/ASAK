...
- 다시 같은 문제가 생기면 먼저 볼 파일/명령어: `NOTION_WEB_AUDIT_LEDGER_2026-07-16.md`, Product Bible API Contract, `CURRENT_IMPLEMENTATION_MAP.md`, ASAK-back의 Controller·Entity·Migration 검색.
...
- [Notion Web Audit Ledger](../../../docs/governance/NOTION_WEB_AUDIT_LEDGER_2026-07-16.md)
- [API·DB 구현 가이드](../../../docs/implementation_guide/04_API_DB_IMPLEMENTATION.md)
