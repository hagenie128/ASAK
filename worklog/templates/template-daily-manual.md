...
|---|---|---|---|---|---|
| {{PERSON}} | ASAK / ASAK-front / ASAK-back | (한 줄 요약) | WBS-000 / #이슈 | 🔄 진행 / ✅ 완료 | - |

---

## 오늘 작업

> 기능·이슈마다 카드 하나. **12섹션 전체**는 [`entries/{{PERSON}}/`](../entries/{{PERSON}}/) — daily에는 아래 **미니 필드**만.
...
- **상세 기록 →** [`entries/{{PERSON}}/{{DATE}}-주제.md`](../entries/{{PERSON}}/{{DATE}}-주제.md)
