...
| 개인별 가이드 | [`guide-personal-worklog.md`](guide-personal-worklog.md) |
...
`NOTION_TOKEN` 설정은 Notion [팀 가이드 §3~§5](https://app.notion.com/p/39451ef04f0b81c0a018e8fe6ea9fb95) 참고.
...
```powershell
python worklog/scripts/init_daily.py
notepad worklog\daily\{본인}\2026-07-06.md
python worklog/scripts/sync_daily_to_notion.py --date today
```
