...
| | **일일** `daily/YYYY-MM-DD.md` | **상세** `entries/` + [03 템플릿](../docs/guides/03-work-log-template.md) |
|---|---|---|
| 단위 | 하루 | 기능·이슈·PR 하나 |
...
- 마지막 줄 **상세 기록 →** `entries/YYYY-MM-DD-주제.md` 링크
...
- **상세 기록 →** [`entries/2026-07-02-scr-003-menu-option-ui.md`](entries/2026-07-02-scr-003-menu-option-ui.md) · [04 예시](../docs/guides/04-sample-work-log-example.md)
```
