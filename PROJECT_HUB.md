...
> **2026-07-20:** 문서 입구는 하나로 모았습니다.  
> 👉 **[START_HERE (여기부터)](docs/START_HERE.md)**
...
| 저장소 | 계획 | 구조 |
|---|---|---|
| ASAK-Kiosk | `IMPLEMENTATION_PLAN.md` | `src/STRUCTURE_GUIDE.md` |
| ASAK-Admin | `IMPLEMENTATION_PLAN.md` | `src/STRUCTURE_GUIDE.md` |
| ASAK-back | `IMPLEMENTATION_PLAN.md` | (health only) |

이 저장소(`ASAK`)는 **문서·데이터·Product Bible** 정본입니다. 앱 소스의 정본은 위 세 저장소입니다.
